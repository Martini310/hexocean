...
from .views import ImageView, download_image, serve_media, GenerateLink #, generate_link, TierViewSet, SizeViewSet
...
urlpatterns = [
    ...
    path('generate-link/', GenerateLink.as_view(), name='generate_link'),
